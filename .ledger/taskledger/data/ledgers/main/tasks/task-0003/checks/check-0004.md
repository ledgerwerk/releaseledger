...
command:
  pytest -q tests/test_version_correction_workflow.py::test_release_coverage_projects_audit_decisions_without_fake_public_refs
...
category: test
summary:
  Ran pytest -q tests/test_version_correction_workflow.py::test_release_coverage_projects_audit_decisions_without_fake_public_refs
  tests/test_git_review.py tests/test_commit_audit.py tests/test_commit_audit_cli.py
  (exit 0)
stdout_ref: null
stderr_ref: null
