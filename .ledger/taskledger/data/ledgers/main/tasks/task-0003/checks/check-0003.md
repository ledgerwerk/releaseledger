...
command:
  pytest -q tests/test_version_correction_workflow.py::test_release_check_renders_every_failed_gate
...
category: test
summary:
  Ran pytest -q tests/test_version_correction_workflow.py::test_release_check_renders_every_failed_gate
