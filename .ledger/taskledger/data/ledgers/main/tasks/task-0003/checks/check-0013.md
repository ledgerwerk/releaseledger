...
command: pytest -q tests/test_cli_inventory.py tests/test_cli_inventory_baseline.py
...
status: passed
category: test
summary: Ran pytest -q tests/test_cli_inventory.py tests/test_cli_inventory_baseline.py
