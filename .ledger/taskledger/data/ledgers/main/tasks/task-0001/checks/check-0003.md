...
command:
  pytest -q tests/test_ledgercore_backend.py tests/test_cli_storage_migrate_v2.py
...
category: test
summary:
  "Ran pytest -q tests/test_ledgercore_backend.py tests/test_cli_storage_migrate_v2.py
