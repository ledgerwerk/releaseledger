...
command: pytest -q tests/test_cli_storage_migrate_v2.py::test_migration_plan_is_hashed_and_stale_source_is_conflict
...
status: passed
category: test
summary: Ran pytest -q tests/test_cli_storage_migrate_v2.py::test_migration_plan_is_hashed_and_stale_source_is_conflict
  tests/test_storage_migration.py::TestModeBehavior::test_move_removes_legacy_after_success
  (exit 0)
stdout_ref: null
stderr_ref: null
